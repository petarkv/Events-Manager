  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom">
          ...
          <a href="#" class="current">Add Gallery</a> </div>
      <h1>Galleries</h1>
        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{ url('/admin/add-gallery') }}" 
                    name="add_gallery" id="add_gallery" novalidate="novalidate">{{ csrf_field() }}                  
